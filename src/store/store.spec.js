...
describe('Store', () => {
  it('should display results when necessary data is provided', () => {
    ...
    const expected = {
      ...
      savings: calculator().calculateSavings(store.getState().appState)
    };

    expect(actual.appState).to.deep.equal(expected);
  });
  ...
  it('should handle a flurry of actions', () => {
    ...
    const lastGoodSavings = calculator().calculateSavings(store.getState().appState);
