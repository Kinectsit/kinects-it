...
// This is a good example of using Node and cheerio to do a simple file
// transformation. In this case, the transformation is useful since we only
// want to track errors in the built production code.
...
// If you choose to use TrackJS, insert your unique token here. To get a token, go to https://trackjs.com
const trackJsToken = '';
...
fs.readFile('src/index.html', 'utf8', (err, markup) => {
  ...
  if (useTrackJs) {
    if (trackJsToken) {
      ...
      console.log(
        colors.yellow('Track errors by TrackJS.com and enter your token in /tools/build.html'));
    }
  }
